"""Create durable Seller order cache and synchronization jobs; no legacy mutations."""
...
metadata = MetaData()
for source_table in ("organizations", "seller_profiles", "auth_users"):
    Table(source_table, metadata, Column("id", Uuid(), primary_key=True))
