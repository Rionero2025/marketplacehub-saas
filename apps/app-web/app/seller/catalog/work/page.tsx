...
export default async function SellerCatalogWorkPage() {
  ...
  return <PortalShell portal="SELLER" displayName={session.display_name} currentPage="work-lists">
    <SellerCatalogPage result={result} view="work-lists" />
  </PortalShell>;
}
