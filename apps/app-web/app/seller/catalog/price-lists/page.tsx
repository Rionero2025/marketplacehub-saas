...
export default async function SellerPriceLists() {
  ...
  return <PortalShell portal="SELLER" displayName={session.display_name} currentPage="price-lists">
    <SellerCatalogPage result={result} view="price-lists" />
  </PortalShell>;
}
