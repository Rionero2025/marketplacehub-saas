...
export default async function SellerMarketplaceAccounts() {
  ...
  return <PortalShell portal="SELLER" displayName={session.display_name} currentPage="marketplace-accounts">
    <MarketplaceConnectionsPage result={result} view="accounts" />
  </PortalShell>;
}
