...
function Body(){
  ...
  return <>
    <PageHeader title="Pannello Seller" description={`${firstName?`Ciao ${firstName}. `:""}Gestisci il negozio selezionato, gli ordini e le attività operative.`} action={<div className="headerActions"><Link className="secondaryButton linkButton" href="/jobs"><Icon name="activity" size={16}/>Attività</Link><Link className="primaryButton linkButton" href="/orders">Apri ordini<Icon name="arrow" size={16}/></Link></div>}/>
