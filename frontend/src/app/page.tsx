...
export default function Home() {
  ...
  return <div className="marketing">
    ...
    <main><section id="piattaforma" className="marketingSection"><span className="eyebrow">Un’organizzazione chiara</span><h2>Uno spazio per ogni ruolo.</h2><div className="roleCards">
      ...
      <article><span>03 / PIATTAFORMA</span><h3>Amministrazione centrale</h3><p>Un’area riservata al team Marketplace Hub per gestire clienti, configurazioni e abbonamenti.</p></article>
    </div></section>
    ...
    </section></main><footer><Logo/><span>Seller · Agency · Amministrazione</span><Link href="/login">Accedi al workspace →</Link></footer>
  </div>;
}
